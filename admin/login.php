            ...
            if ($user) {
                ...
                if(password_verify($passTest, $user["password"])){
                    ...
                    if(!empty($_POST['remember'])){
                        setcookie ('admin-login', $userTest, time() + (60 * 60 * 24 * 365 * 10));
                    }
                    else{
                                ...
                                <form method="POST" class="my-login-validation" onSubmit="">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-checkbox custom-control">
                                            <input type="checkbox" name="remember" id="remember" class="custom-control-input" <?php if(isset($_COOKIE['admin-login'])) {?> checked <?php } ?>>
