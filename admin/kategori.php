<?php
    ...
    $ambil_data_kategori = "SELECT * FROM kategori";
    ...
    if (isset($_GET['delete'])){
        ...
        $hapus_data_produk = "DELETE FROM kategori WHERE kategori_id = '" . $_GET["delete"] ."'";
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="p-15 m-t-10"><a href="kategori/tambah.php"
