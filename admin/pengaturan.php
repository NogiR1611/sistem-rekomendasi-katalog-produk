                        ...
                        <li>
                            ...
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                ...
                                <div class="user-content hide-menu m-l-10 d-flex align-items-center">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-start" aria-labelledby="Userdd">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material mx-2" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="password"
                                                class="form-control form-control-line" name="password_lama" id="password_lama" required data-eye>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="password"
                                                class="form-control form-control-line" name="password_baru" id="password_baru" required data-eye>   
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="password"
                                                class="form-control form-control-line" name="konf_password" id="konf_password" required data-eye> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success text-white" type="submit" name="ganti">Ganti Profil</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
